...
Metricas YOLO v1 en `data/yolo` test, ya documentadas en `docs/yolo_v1_training.md`:
...
Metricas CNN contextual v2 en `data/classifier_context_v2/test`, ya documentadas en `docs/cnn_context_v2_training.md`:
